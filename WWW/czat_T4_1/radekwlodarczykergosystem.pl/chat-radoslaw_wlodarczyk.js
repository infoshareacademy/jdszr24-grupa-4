...
//   const webhookUrl =
//     "http://localhost:5678/webhook-test/chat-radoslaw_wlodarczyk";
...
//     return "Brak odpowiedzi z workflow.";
//   }
...
//       addMessage(
//         "Nie udało się połączyć z chatbotem. Sprawdź, czy webhook w n8n nadal nasłuchuje i czy przeglądarka nie blokuje CORS.",
//         "system",
//       );
//     } finally {
...
//   addMessage("Cześć! Napisz wiadomość, a połączę się z workflow w n8n.", "bot");
// })();
...
(function () {
  ...
  // TU WPISZ PUBLICZNY ADRES N8N, NIE localhost
  // Przykład:
  // const webhookUrl = "https://n8n.twojadomena.pl/webhook/chat-radoslaw_wlodarczyk";
  // webhookUrl = webhookUr2 = webhookUr3;
  ...
  async function sendMessage() {
    ...
    try {
      ...
      console.error("Błąd połączenia z n8n:", error);
      addMessage(
        "Nie udało się pobrać odpowiedzi z n8n. Sprawdź produkcyjny webhook, aktywność workflow i ustawienia CORS.",
        "system",
      );
    } finally {
      setLoadingState(false);
  ...
  addMessage("Pisz! Już my Cię u..rządzimy!", "bot");
})();
